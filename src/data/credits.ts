...
export const CREDITS: CreditSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        project: 'Bun',
        url: 'https://bun.sh',
        usage: 'Runtime for the AI and email-sender microservices — fast startup, hot reload, native TypeScript.',
        icon: ic(siBun),
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        package: 'nats',
        url: 'https://nats.io',
        usage: 'Inter-service messaging — the email sender subscribes, the backend publishes, the AI service coordinates.',
        icon: ic(siNatsdotio),
      },
    ],
  },
    ...
    items: [
      {
        ...
        usage: 'AI streaming responses, tool calling, and message handling in the Primebrick AI orchestrator.',
        icon: ic(siVercel),
      },
      {
        author: 'Anthropic',
        ...
        usage: 'The open standard that lets the AI microservice discover and call backend tools — MCP server + client.',
        icon: ic(siAnthropic),
      },
      {
    ...
    items: [
      {
        ...
        usage: 'Renders email templates in the email-sender microservice and HTML export templates in the backend.',
