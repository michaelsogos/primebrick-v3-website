...
export const translations = {
  en: {
    ...
    collaboration: {
      ...
      title: 'Real-time collaboration no backoffice has ever had.',
      text: 'See who\u2019s editing in real time. When a colleague saves, their changes merge into your form silently — field by field, never the whole entity. If you both touched the same field, you pick which value wins. No refresh, no lost work, always in sync.',
      cards: [
        ...
        { title: 'Optimistic locking', text: 'State-of-the-art optimistic concurrency built in. No more silent overwrites, no more lost data — just safe, conflict-free saves.' },
      ],
      techNote: 'Real-time stack: SSE + Redis® + NATS™ · Works on HTTP/1.1 or HTTP/2',
      autoEnabled: 'One decorator to sync them all — zero config, ready from minute one',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Private by design',
      title: 'An AI assistant that knows your domain. And never leaves your infrastructure.',
      text: 'Primebrick AI Chat is integrated into the backoffice, not bolted on. The LLM runs as a local container, the knowledge base lives in your PostgreSQL®, and conversations stay in your database. Zero cloud LLM calls by default — privacy is the default, not an option.',
      cards: [
        { title: 'Integrated & Private', text: 'AI chat lives inside your backoffice. Prompts, responses, and conversations never leave your infrastructure. The LLM runs as a local container — zero cloud calls by default.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Default model: Qwen3™-4B-Instruct-2507, licensed under Apache 2.0. Runs on CPU with ~2.5GB RAM. No GPU required, no commercial licenses, no vendor lock-in.' },
        { title: 'OpenAI®-compatible', text: 'The runtime exposes an OpenAI®-compatible API. Swap to OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™, or any compatible provider by changing one config key. Your code stays the same.' },
        { title: 'Compliance-ready', text: 'All-Apache-2.0 stack (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Air-gapped deployment supported. GDPR-aligned: no data transfer to third-party LLM providers. Suitable for regulated industries.' },
      ],
      privacyNote: 'No data leaves your infrastructure. Default configuration runs 100% on-premise. Cloud LLM is optional and opt-in — you explicitly configure it if you want it.',
      privacyBadge: 'No data leaves your infrastructure',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      ...
      title: 'ISO 27001 & NIS2. Scanned, not self-reported.',
      text: 'An automated compliance scanner reads the Primebrick source code on every build and maps security controls to ISO 27001 Annex A, NIS2 Article 21(2), and OWASP Top 10 — with file:line evidence for each control. No manual questionnaires, no self-assessment spreadsheets. Download the full report as PDF and see exactly what is compliant, what is partial, and where the evidence lives.',
      cards: [
        { title: 'ISO 27001 Annex A', text: '17 controls mapped to Annex A (A.5, A.6, A.8) with evidence: RBAC, audit trail, encryption, access control, and more.' },
        { title: 'NIS2 Article 21(2)', text: 'All 10 mandatory security measures covered: incident management, business continuity, supply chain security, cryptography.' },
        { title: 'OWASP Top 10', text: 'Injection, auth failures, cryptographic failures, misconfiguration — mapped to actual code patterns with evidence.' },
        { title: 'Downloadable PDF report', text: 'Full compliance report generated as PDF on every build. Hand it to your auditors, compliance team, or security reviewers.' },
      ],
      cta: { label: 'View compliance report', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR & CCPA',
      title: 'Data privacy by design. With evidence.',
      text: 'Primebrick implements GDPR and CCPA requirements at the code level: multi-tenant data isolation, soft-delete with recovery, audit trails for Article 30 records, data minimization via field-level access control. The automated scanner verifies these controls against the actual source code and produces a compliance report you can download.',
      cards: [
        { title: 'GDPR Article 32', text: 'Security of processing: encryption in transit, multi-tenant isolation, audit trails. Verified by code pattern scanning.' },
        { title: 'GDPR Article 17', text: 'Right to erasure: soft-delete with deleted_at column and restore capability. Data is recoverable, not destroyed.' },
        { title: 'CCPA §1798.150', text: 'Consumer data protection: access controls, audit trails, and data minimization mapped to California Consumer Privacy Act.' },
        { title: 'Article 30 records', text: 'Automated audit trail logging satisfies GDPR Article 30 record-of-processing requirements. Every CRUD operation is logged.' },
      ],
      cta: { label: 'View GDPR & CCPA assessment', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      ...
      title: 'Thank You',
      subtitle: 'Primebrick stands on the shoulders of giants. This page is a heartfelt thank-you to every person, team, and organization whose open-source work made this project possible — across every repository, every line of docs, and this website itself.',
      spiritTitle: 'The Spirit of Open Source',
      spiritText: 'Open source is not just a license — it is a pact between strangers who choose to share their best work with the world, for free, forever. Every line of code we depend on was written by someone who decided that collaboration matters more than control, that transparency beats secrecy, and that giving back is the whole point.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'The best thing about open source is that you can build on the work of others. — Anonymous',
      ],
      weThank: 'We thank',
      sectionFoundation: 'Languages & Runtimes',
      sectionFrameworks: 'The Frameworks',
      sectionBuild: 'Build & Tooling',
      sectionUi: 'UI & Styling',
      sectionData: 'Data, Messaging & Caching',
      sectionAuth: 'Auth & Security',
      sectionAi: 'AI & Machine Learning',
      sectionDocs: 'Docs & Diagrams',
  ...
  it: {
    ...
    collaboration: {
      ...
      title: 'Collaborazione in tempo reale che nessun backoffice ha mai avuto.',
      text: 'Vedi chi sta modificando in tempo reale. Quando un collega salva, le sue modifiche si uniscono al tuo form silenziosamente — campo per campo, mai l\u2019intera entità. Se avete toccato lo stesso campo, scegli tu quale valore vince. Nessun refresh, nessun lavoro perso, sempre sincronizzati.',
      cards: [
        ...
        { title: 'Locking ottimistico', text: 'Concorrenza ottimistica state-of-the-art integrata. Niente più sovrascritture silenziose, niente più dati persi — solo salvataggi sicuri e senza conflitti.' },
      ],
      techNote: 'Stack real-time: SSE + Redis® + NATS™ · Funziona su HTTP/1.1 o HTTP/2',
      autoEnabled: 'Un decorator per sincronizzarli tutti — zero config, pronto dal primo minuto',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Privato per design',
      title: 'Un assistente AI che conosce il tuo dominio. E non lascia mai la tua infrastruttura.',
      text: 'Primebrick AI Chat è integrato nel backoffice, non bolted on. Il LLM gira come container locale, la knowledge base vive nel tuo PostgreSQL®, le conversazioni restano nel tuo database. Zero chiamate a LLM cloud nella configurazione default — la privacy è il default, non un\'opzione.',
      cards: [
        { title: 'Integrato & Privato', text: 'La AI chat vive dentro il tuo backoffice. Prompt, risposte e conversazioni non escono mai dalla tua infrastruttura. Il LLM gira come container locale — zero chiamate cloud di default.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Modello default: Qwen3™-4B-Instruct-2507, licenza Apache 2.0. Gira su CPU con ~2.5GB RAM. Nessuna GPU richiesta, nessuna licenza commerciale, nessun vendor lock-in.' },
        { title: 'OpenAI®-compatible', text: 'Il runtime espone un\'API OpenAI®-compatible. Passa a OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™ o qualsiasi provider compatible cambiando una chiave di config. Il tuo codice non cambia.' },
        { title: 'Pronto per la compliance', text: 'Stack tutto Apache-2.0 (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Deployment air-gapped supportato. GDPR-aligned: nessun trasferimento dati a provider LLM terzi. Adatto a settori regolati.' },
      ],
      privacyNote: 'Nessun dato lascia la tua infrastruttura. La configurazione default gira 100% on-premise. Il LLM cloud è opzionale e opt-in — lo configuri esplicitamente solo se lo vuoi.',
      privacyBadge: 'Nessun dato lascia la tua infrastruttura',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      badge: 'Conformità Sicurezza',
      title: 'ISO 27001 e NIS2. Scansionato, non auto-dichiarato.',
      text: 'Uno scanner di conformità automatizzato legge il codice sorgente di Primebrick ad ogni build e mappa i controlli di sicurezza a ISO 27001 Allegato A, NIS2 Articolo 21(2) e OWASP Top 10 — con evidenza file:riga per ogni controllo. Nessun questionario manuale, nessun foglio di calcolo. Scarica il report completo in PDF e vedi esattamente cosa è conforme, cosa è parziale, e dove vive l\'evidenza.',
      cards: [
        { title: 'ISO 27001 Allegato A', text: '17 controlli mappati all\'Allegato A (A.5, A.6, A.8) con evidenza: RBAC, audit trail, crittografia, controllo accessi.' },
        { title: 'NIS2 Articolo 21(2)', text: 'Tutte le 10 misure di sicurezza obbligatorie coperte: gestione incidenti, continuità aziendale, sicurezza supply chain.' },
        { title: 'OWASP Top 10', text: 'Injection, failure di autenticazione, failure crittografiche, misconfiguration — mappati a pattern di codice reali con evidenza.' },
        { title: 'Report PDF scaricabile', text: 'Report di conformità completo generato come PDF ad ogni build. Consegnalo ai tuoi auditor o team di compliance.' },
      ],
      cta: { label: 'Vedi report di conformità', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR e CCPA',
      title: 'Privacy by design. Con evidenza.',
      text: 'Primebrick implementa i requisiti GDPR e CCPA a livello di codice: isolamento dati multi-tenant, soft-delete con recupero, audit trail per Article 30, minimizzazione dati tramite controllo accessi a livello campo. Lo scanner automatizzato verifica questi controlli contro il codice sorgente reale e produce un report di conformità scaricabile.',
      cards: [
        { title: 'GDPR Articolo 32', text: 'Sicurezza del trattamento: crittografia in transito, isolamento multi-tenant, audit trail. Verificato da scansione di codice.' },
        { title: 'GDPR Articolo 17', text: 'Diritto alla cancellazione: soft-delete con colonna deleted_at e capacità di ripristino. I dati sono recuperabili.' },
        { title: 'CCPA §1798.150', text: 'Protezione dati consumer: controlli accessi, audit trail, e minimizzazione dati mappati al California Consumer Privacy Act.' },
        { title: 'Registri Article 30', text: 'Audit trail automatizzato soddisfa i requisiti GDPR Article 30 di registrazione del trattamento. Ogni operazione CRUD è loggata.' },
      ],
      cta: { label: 'Vedi valutazione GDPR e CCPA', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      badge: 'Open Source • Costruito Insieme • Libero Per Sempre',
      title: 'Grazie',
      subtitle: 'Primebrick poggia sulle spalle dei giganti. Questa pagina è un ringraziamento sentito a ogni persona, team e organizzazione il cui lavoro open-source ha reso possibile questo progetto — in ogni repository, in ogni riga di documentazione e in questo stesso sito.',
      spiritTitle: 'Lo Spirito dell\'Open Source',
      spiritText: 'L\'open source non è solo una licenza — è un patto tra sconosciuti che scelgono di condividere il loro lavoro migliore con il mondo, gratuitamente, per sempre. Ogni riga di codice su cui ci appoggiamo è stata scritta da qualcuno che ha deciso che la collaborazione conta più del controllo, che la trasparenza batte il segreto e che restituire è il senso di tutto.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'Il bello dell\'open source è che puoi costruire sul lavoro degli altri. — Anonimo',
      ],
      weThank: 'Ringraziamo',
      sectionFoundation: 'Linguaggi & Runtime',
      sectionFrameworks: 'I Framework',
      sectionBuild: 'Build & Strumenti',
      sectionUi: 'UI & Styling',
      sectionData: 'Dati, Messaggistica & Caching',
      sectionAuth: 'Auth & Sicurezza',
      sectionAi: 'AI & Machine Learning',
      sectionDocs: 'Docs & Diagrammi',
      sectionExport: 'Templating & Export',
      ...
      ctaContribute: 'Contribuisci su GitHub®',
  ...
  de: {
    ...
    collaboration: {
      ...
      title: 'Echtzeit-Kollaboration, die kein Backoffice je hatte.',
      text: 'Sehen Sie in Echtzeit, wer bearbeitet. Wenn ein Kollege speichert, werden seine Änderungen still in Ihr Formular eingemischt — Feld für Feld, nie die gesamte Entität. Wenn Sie beide dasselbe Feld bearbeitet haben, wählen Sie, welcher Wert gewinnt. Kein Refresh, keine verlorene Arbeit, immer synchron.',
      cards: [
        ...
        { title: 'Optimistisches Locking', text: 'State-of-the-art optimistische Nebenläufigkeit eingebaut. Keine stillen Überschreibungen mehr, keine verlorenen Daten mehr — nur sichere, konfliktfreie Speicherungen.' },
      ],
      techNote: 'Echtzeit-Stack: SSE + Redis® + NATS™ · Funktioniert auf HTTP/1.1 oder HTTP/2',
      autoEnabled: 'Ein Decorator, um sie alle zu synchronisieren — zero Config, ab Minute eins bereit',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Private by design',
      title: 'Ein KI-Assistent, der Ihre Domäne kennt. Und Ihre Infrastruktur nie verlässt.',
      text: 'Primebrick AI Chat ist in das Backoffice integriert, nicht aufgesetzt. Das LLM läuft als lokaler Container, die Wissensbasis lebt in Ihrem PostgreSQL®, Konversationen bleiben in Ihrer Datenbank. Standardmäßig keine Cloud-LLM-Aufrufe — Privacy ist der Standard, keine Option.',
      cards: [
        { title: 'Integriert & Privat', text: 'AI Chat lebt in Ihrem Backoffice. Prompts, Antworten und Konversationen verlassen nie Ihre Infrastruktur. Das LLM läuft als lokaler Container — standardmäßig keine Cloud-Aufrufe.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Standardmodell: Qwen3™-4B-Instruct-2507, lizenziert unter Apache 2.0. Läuft auf CPU mit ~2,5 GB RAM. Keine GPU erforderlich, keine kommerziellen Lizenzen, kein Vendor-Lock-in.' },
        { title: 'OpenAI®-compatible', text: 'Die Runtime stellt eine OpenAI®-compatible API bereit. Wechseln Sie zu OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™ oder jedem compatible Provider, indem Sie einen Config-Schlüssel ändern. Ihr Code bleibt derselbe.' },
        { title: 'Compliance-bereit', text: 'All-Apache-2.0-Stack (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Air-gapped-Deployment unterstützt. GDPR-aligned: keine Datenübertragung an LLM-Provider von Drittanbietern. Geeignet für regulierte Branchen.' },
      ],
      privacyNote: 'Keine Daten verlassen Ihre Infrastruktur. Die Standardkonfiguration läuft zu 100% On-Premise. Cloud-LLM ist optional und Opt-in — Sie konfigurieren sie explizit, wenn Sie sie wollen.',
      privacyBadge: 'Keine Daten verlassen Ihre Infrastruktur',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      badge: 'Sicherheits-Compliance',
      title: 'ISO 27001 & NIS2. Gescannt, nicht selbst gemeldet.',
      text: 'Ein automatisierter Compliance-Scanner liest den Primebrick-Quellcode bei jedem Build und ordnet Sicherheitskontrollen ISO 27001 Anhang A, NIS2 Artikel 21(2) und OWASP Top 10 zu — mit Datei:Zeile-Evidenz für jede Kontrolle. Keine manuellen Fragebögen, keine Tabellen. Laden Sie den vollständigen Bericht als PDF herunter.',
      cards: [
        { title: 'ISO 27001 Anhang A', text: '17 Kontrollen zugeordnet zu Anhang A (A.5, A.6, A.8) mit Evidenz: RBAC, Audit-Trail, Verschlüsselung, Zugriffskontrolle.' },
        { title: 'NIS2 Artikel 21(2)', text: 'Alle 10 obligatorischen Sicherheitsmaßnahmen abgedeckt: Incident Management, Business Continuity, Supply Chain Security.' },
        { title: 'OWASP Top 10', text: 'Injection, Authentifizierungsfehler, kryptografische Fehler, Fehlkonfiguration — zugeordnet zu echten Code-Patterns.' },
        { title: 'PDF-Bericht herunterladbar', text: 'Vollständiger Compliance-Bericht wird bei jedem Build als PDF generiert. Übergeben Sie ihn an Ihre Auditoren.' },
      ],
      cta: { label: 'Compliance-Bericht ansehen', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR & CCPA',
      title: 'Privacy by Design. Mit Evidenz.',
      text: 'Primebrick implementiert GDPR- und CCPA-Anforderungen auf Code-Ebene: Multi-Tenant-Datenisolation, Soft-Delete mit Wiederherstellung, Audit-Trails für Artikel 30, Datenminimierung durch Feld-Level-Zugriffskontrolle. Der automatisierte Scanner verifiziert diese Kontrollen gegen den tatsächlichen Quellcode.',
      cards: [
        { title: 'GDPR Artikel 32', text: 'Sicherheit der Verarbeitung: Verschlüsselung, Multi-Tenant-Isolation, Audit-Trails. Verifiziert durch Code-Pattern-Scanning.' },
        { title: 'GDPR Artikel 17', text: 'Recht auf Löschung: Soft-Delete mit deleted_at-Spalte und Wiederherstellungsfunktion. Daten sind wiederherstellbar.' },
        { title: 'CCPA §1798.150', text: 'Verbraucherdatenschutz: Zugriffskontrollen, Audit-Trails und Datenminimierung zugeordnet zum California Consumer Privacy Act.' },
        { title: 'Artikel 30 Aufzeichnungen', text: 'Automatisierte Audit-Trail-Protokollierung erfüllt GDPR Artikel 30 Anforderungen. Jede CRUD-Operation wird protokolliert.' },
      ],
      cta: { label: 'GDPR & CCPA Bewertung ansehen', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      badge: 'Open Source • Gemeinsam Gebaut • Für Immer Frei',
      title: 'Danke',
      subtitle: 'Primebrick steht auf den Schultern von Riesen. Diese Seite ist ein herzliches Dankeschön an jede Person, jedes Team und jede Organisation, deren Open-Source-Arbeit dieses Projekt möglich gemacht hat — in jedem Repository, in jeder Zeile Dokumentation und auf dieser Website selbst.',
      spiritTitle: 'Der Geist von Open Source',
      spiritText: 'Open Source ist nicht nur eine Lizenz — sie ist ein Pakt zwischen Fremden, die sich entscheiden, ihre beste Arbeit mit der Welt zu teilen, kostenlos, für immer. Jede Codezeile, auf die wir uns stützen, wurde von jemandem geschrieben, der entschied, dass Zusammenarbeit mehr zählt als Kontrolle, dass Transparenz Geheimnistuerei schlägt und dass Zurückgeben der Sinn der Sache ist.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'Das Schöne an Open Source ist, dass man auf der Arbeit anderer aufbauen kann. — Anonym',
      ],
      weThank: 'Wir danken',
      sectionFoundation: 'Sprachen & Laufzeitumgebungen',
      sectionFrameworks: 'Die Frameworks',
      sectionBuild: 'Build & Werkzeuge',
      sectionUi: 'UI & Styling',
      sectionData: 'Daten, Messaging & Caching',
      sectionAuth: 'Auth & Sicherheit',
      sectionAi: 'KI & Machine Learning',
      sectionDocs: 'Doku & Diagramme',
      sectionExport: 'Templating & Export',
      ...
      ctaContribute: 'Auf GitHub® beitragen',
  ...
  es: {
    ...
    collaboration: {
      ...
      title: 'Colaboración en tiempo real que ningún backoffice ha tenido.',
      text: 'Vea quién está editando en tiempo real. Cuando un colega guarda, sus cambios se combinan en su formulario silenciosamente — campo por campo, nunca la entidad completa. Si ambos tocaron el mismo campo, usted elige qué valor gana. Sin refresh, sin trabajo perdido, siempre sincronizados.',
      cards: [
        ...
        { title: 'Bloqueo optimista', text: 'Concurrencia optimista state-of-the-art integrada. No más sobrescrituras silenciosas, no más datos perdidos — solo guardados seguros y sin conflictos.' },
      ],
      techNote: 'Stack en tiempo real: SSE + Redis® + NATS™ · Funciona en HTTP/1.1 o HTTP/2',
      autoEnabled: 'Un decorator para sincronizarlos todos — zero config, listo desde el minuto uno',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Privado por diseño',
      title: 'Un asistente de IA que conoce tu dominio. Y nunca deja tu infraestructura.',
      text: 'Primebrick AI Chat está integrado en el backoffice, no añadido por encima. El LLM se ejecuta como un contenedor local, la base de conocimiento vive en tu PostgreSQL®, las conversaciones permanecen en tu base de datos. Cero llamadas a LLM en la nube por defecto — la privacidad es el valor predeterminado, no una opción.',
      cards: [
        { title: 'Integrado y Privado', text: 'AI Chat vive dentro de tu backoffice. Los prompts, las respuestas y las conversaciones nunca salen de tu infraestructura. El LLM se ejecuta como contenedor local — cero llamadas a la nube por defecto.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Modelo por defecto: Qwen3™-4B-Instruct-2507, licenciado bajo Apache 2.0. Se ejecuta en CPU con ~2,5GB RAM. No se requiere GPU, sin licencias comerciales, sin vendor lock-in.' },
        { title: 'OpenAI®-compatible', text: 'El runtime expone una API OpenAI®-compatible. Cambia a OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™ o cualquier provider compatible cambiando una clave de config. Tu código no cambia.' },
        { title: 'Listo para compliance', text: 'Stack todo Apache-2.0 (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Despliegue air-gapped soportado. GDPR-aligned: sin transferencia de datos a proveedores LLM de terceros. Adecuado para sectores regulados.' },
      ],
      privacyNote: 'Ningún dato sale de tu infraestructura. La configuración por defecto se ejecuta 100% on-premise. El LLM en la nube es opcional y opt-in — lo configuras explícitamente solo si lo quieres.',
      privacyBadge: 'Ningún dato sale de tu infraestructura',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      badge: 'Cumplimiento de Seguridad',
      title: 'ISO 27001 y NIS2. Escaneado, no auto-reportado.',
      text: 'Un escáner de cumplimiento automatizado lee el código fuente de Primebrick en cada build y mapea los controles de seguridad a ISO 27001 Anexo A, NIS2 Artículo 21(2) y OWASP Top 10 — con evidencia archivo:línea para cada control. Sin cuestionarios manuales. Descarga el reporte completo en PDF.',
      cards: [
        { title: 'ISO 27001 Anexo A', text: '17 controles mapeados al Anexo A (A.5, A.6, A.8) con evidencia: RBAC, audit trail, cifrado, control de acceso.' },
        { title: 'NIS2 Artículo 21(2)', text: 'Las 10 medidas de seguridad obligatorias cubiertas: gestión de incidentes, continuidad de negocio, seguridad de cadena de suministro.' },
        { title: 'OWASP Top 10', text: 'Injection, fallos de autenticación, fallos criptográficos, misconfiguration — mapeados a patrones de código reales con evidencia.' },
        { title: 'Reporte PDF descargable', text: 'Reporte de cumplimiento completo generado como PDF en cada build. Entrégalo a tus auditores o equipo de compliance.' },
      ],
      cta: { label: 'Ver reporte de cumplimiento', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR y CCPA',
      title: 'Privacy by design. Con evidencia.',
      text: 'Primebrick implementa los requisitos GDPR y CCPA a nivel de código: aislamiento de datos multi-tenant, soft-delete con recuperación, audit trails para Artículo 30, minimización de datos mediante control de acceso a nivel campo. El escáner automatizado verifica estos controles contra el código fuente real.',
      cards: [
        { title: 'GDPR Artículo 32', text: 'Seguridad del tratamiento: cifrado en tránsito, aislamiento multi-tenant, audit trails. Verificado por escaneo de código.' },
        { title: 'GDPR Artículo 17', text: 'Derecho al borrado: soft-delete con columna deleted_at y capacidad de restauración. Los datos son recuperables.' },
        { title: 'CCPA §1798.150', text: 'Protección de datos del consumidor: controles de acceso, audit trails y minimización de datos mapeados al California Consumer Privacy Act.' },
        { title: 'Registros Artículo 30', text: 'Audit trail automatizado satisface los requisitos GDPR Artículo 30 de registro del tratamiento. Cada operación CRUD es registrada.' },
      ],
      cta: { label: 'Ver evaluación GDPR y CCPA', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      badge: 'Open Source • Construido Juntos • Libre Para Siempre',
      title: 'Gracias',
      subtitle: 'Primebrick se apoya en hombros de gigantes. Esta página es un agradecimiento sincero a cada persona, equipo y organización cuyo trabajo open-source hizo posible este proyecto — en cada repositorio, en cada línea de documentación y en este mismo sitio.',
      spiritTitle: 'El Espíritu del Open Source',
      spiritText: 'El open source no es solo una licencia — es un pacto entre desconocidos que eligen compartir su mejor trabajo con el mundo, gratis, para siempre. Cada línea de código en la que nos apoyamos fue escrita por alguien que decidió que la colaboración importa más que el control, que la transparencia vence al secreto y que devolver es el sentido de todo.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'Lo mejor del open source es que puedes construir sobre el trabajo de otros. — Anónimo',
      ],
      weThank: 'Agradecemos a',
      sectionFoundation: 'Lenguajes & Runtimes',
      sectionFrameworks: 'Los Frameworks',
      sectionBuild: 'Build & Herramientas',
      sectionUi: 'UI & Estilos',
      sectionData: 'Datos, Mensajería & Caching',
      sectionAuth: 'Auth & Seguridad',
      sectionAi: 'IA & Machine Learning',
      sectionDocs: 'Docs & Diagramas',
      sectionExport: 'Templating & Export',
      ...
      ctaContribute: 'Contribuir en GitHub®',
  ...
  pt: {
    ...
    collaboration: {
      ...
      title: 'Colaboração em tempo real que nenhum backoffice já teve.',
      text: 'Veja quem está a editar em tempo real. Quando um colega guarda, as suas alterações combinam-se no seu formulário silenciosamente — campo por campo, nunca a entidade completa. Se ambos tocaram no mesmo campo, você escolhe qual valor ganha. Sem refresh, sem trabalho perdido, sempre sincronizados.',
      cards: [
        ...
        { title: 'Bloqueio otimista', text: 'Concorrência otimista state-of-the-art integrada. Chega de sobrescritas silenciosas, chega de dados perdidos — apenas guardas seguros e sem conflitos.' },
      ],
      techNote: 'Stack em tempo real: SSE + Redis® + NATS™ · Funciona em HTTP/1.1 ou HTTP/2',
      autoEnabled: 'Um decorator para sincronizar todos — zero config, pronto desde o primeiro minuto',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Privado por design',
      title: 'Um assistente de IA que conhece o teu domínio. E nunca sai da tua infraestrutura.',
      text: 'O Primebrick AI Chat está integrado no backoffice, não sobreposto. O LLM corre como um contentor local, a base de conhecimento vive no teu PostgreSQL®, as conversas ficam na tua base de dados. Zero chamadas para LLM na nuvem por defeito — a privacidade é o padrão, não uma opção.',
      cards: [
        { title: 'Integrado e Privado', text: 'O AI Chat vive dentro do teu backoffice. Os prompts, as respostas e as conversas nunca saem da tua infraestrutura. O LLM corre como contentor local — zero chamadas à nuvem por defeito.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Modelo padrão: Qwen3™-4B-Instruct-2507, licenciado sob Apache 2.0. Corre em CPU com ~2,5GB RAM. Sem GPU necessário, sem licenças comerciais, sem vendor lock-in.' },
        { title: 'OpenAI®-compatible', text: 'O runtime expõe uma API OpenAI®-compatible. Muda para OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™ ou qualquer provider compatible alterando uma chave de config. O teu código não muda.' },
        { title: 'Pronto para compliance', text: 'Stack todo Apache-2.0 (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Deployment air-gapped suportado. GDPR-aligned: sem transferência de dados para providers LLM de terceiros. Adequado para setores regulados.' },
      ],
      privacyNote: 'Nenhum dado sai da tua infraestrutura. A configuração padrão corre 100% on-premise. O LLM na nuvem é opcional e opt-in — configuras-o explicitamente apenas se o quiseres.',
      privacyBadge: 'Nenhum dado sai da tua infraestrutura',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      badge: 'Conformidade de Segurança',
      title: 'ISO 27001 e NIS2. Analisado, não auto-reportado.',
      text: 'Um scanner de conformidade automatizado lê o código-fonte do Primebrick em cada build e mapeia os controlos de segurança para ISO 27001 Anexo A, NIS2 Artigo 21(2) e OWASP Top 10 — com evidência ficheiro:linha para cada controlo. Sem questionários manuais. Descarrega o relatório completo em PDF.',
      cards: [
        { title: 'ISO 27001 Anexo A', text: '17 controlos mapeados ao Anexo A (A.5, A.6, A.8) com evidência: RBAC, audit trail, encriptação, controlo de acesso.' },
        { title: 'NIS2 Artigo 21(2)', text: 'As 10 medidas de segurança obrigatórias cobertas: gestão de incidentes, continuidade de negócio, segurança da cadeia de fornecimento.' },
        { title: 'OWASP Top 10', text: 'Injection, falhas de autenticação, falhas criptográficas, misconfiguration — mapeados a padrões de código reais com evidência.' },
        { title: 'Relatório PDF descarregável', text: 'Relatório de conformidade completo gerado como PDF em cada build. Entrega-o aos teus auditores ou equipa de compliance.' },
      ],
      cta: { label: 'Ver relatório de conformidade', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR e CCPA',
      title: 'Privacy by design. Com evidência.',
      text: 'Primebrick implementa os requisitos GDPR e CCPA ao nível do código: isolamento de dados multi-tenant, soft-delete com recuperação, audit trails para Artigo 30, minimização de dados através de controlo de acesso ao nível campo. O scanner automatizado verifica estes controlos contra o código-fonte real.',
      cards: [
        { title: 'GDPR Artigo 32', text: 'Segurança do tratamento: encriptação em trânsito, isolamento multi-tenant, audit trails. Verificado por análise de código.' },
        { title: 'GDPR Artigo 17', text: 'Direito ao apagamento: soft-delete com coluna deleted_at e capacidade de restauro. Os dados são recuperáveis.' },
        { title: 'CCPA §1798.150', text: 'Proteção de dados do consumidor: controlos de acesso, audit trails e minimização de dados mapeados ao California Consumer Privacy Act.' },
        { title: 'Registos Artigo 30', text: 'Audit trail automatizado satisfaz os requisitos GDPR Artigo 30 de registo do tratamento. Cada operação CRUD é registada.' },
      ],
      cta: { label: 'Ver avaliação GDPR e CCPA', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      badge: 'Open Source • Construído Juntos • Livre Para Sempre',
      title: 'Obrigado',
      subtitle: 'Primebrick apoia-se em ombros de gigantes. Esta página é um agradecimento sincero a cada pessoa, equipe e organização cujo trabalho open-source tornou este projeto possível — em cada repositório, em cada linha de documentação e neste próprio site.',
      spiritTitle: 'O Espírito do Open Source',
      spiritText: 'Open source não é apenas uma licença — é um pacto entre desconhecidos que escolhem compartilhar seu melhor trabalho com o mundo, de graça, para sempre. Cada linha de código da qual dependemos foi escrita por alguém que decidiu que a colaboração importa mais que o controle, que a transparência vence o segredo e que devolver é o sentido de tudo.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'O melhor do open source é que você pode construir sobre o trabalho dos outros. — Anônimo',
      ],
      weThank: 'Agradecemos a',
      sectionFoundation: 'Linguagens & Runtimes',
      sectionFrameworks: 'Os Frameworks',
      sectionBuild: 'Build & Ferramentas',
      sectionUi: 'UI & Estilos',
      sectionData: 'Dados, Mensageria & Caching',
      sectionAuth: 'Auth & Segurança',
      sectionAi: 'IA & Machine Learning',
      sectionDocs: 'Docs & Diagramas',
      sectionExport: 'Templating & Export',
      ...
      ctaContribute: 'Contribuir no GitHub®',
  ...
  fr: {
    ...
    collaboration: {
      ...
      cards: [
        ...
        { title: 'Verrouillage optimiste', text: 'Concurrence optimiste state-of-the-art intégrée. Plus d\'écrasements silencieux, plus de données perdues — juste des sauvegardes sûres et sans conflit.' },
      ],
      techNote: 'Stack temps réel : SSE + Redis® + NATS™ · Fonctionne sur HTTP/1.1 ou HTTP/2',
      autoEnabled: 'Un decorator pour les synchroniser tous — zero config, prêt dès la première minute',
    },
    enterprise: {
    ...
    ai: {
      badge: 'AI Chat — Privé par design',
      title: 'Un assistant IA qui connaît votre domaine. Et ne quitte jamais votre infrastructure.',
      text: 'Primebrick AI Chat est intégré au backoffice, pas rajouté. Le LLM s\'exécute comme un conteneur local, la base de connaissances vit dans votre PostgreSQL®, les conversations restent dans votre base de données. Zéro appel à un LLM cloud par défaut — la confidentialité est la valeur par défaut, pas une option.',
      cards: [
        { title: 'Intégré et Privé', text: 'AI Chat vit dans votre backoffice. Les prompts, les réponses et les conversations ne quittent jamais votre infrastructure. Le LLM s\'exécute comme conteneur local — zéro appel cloud par défaut.' },
        { title: 'Qwen3™ — Apache 2.0', text: 'Modèle par défaut : Qwen3™-4B-Instruct-2507, sous licence Apache 2.0. S\'exécute sur CPU avec ~2,5 Go de RAM. Aucun GPU requis, aucune licence commerciale, aucun vendor lock-in.' },
        { title: 'OpenAI®-compatible', text: 'Le runtime expose une API OpenAI®-compatible. Passez à OpenAI®, Anthropic™, Zhipu™ GLM™, DeepSeek™, Groq™ ou tout provider compatible en changeant une clé de config. Votre code ne change pas.' },
        { title: 'Prêt pour la conformité', text: 'Stack tout Apache-2.0 (mistral.rs™, Qwen3™, Vercel AI SDK™, pgvector™). Déploiement air-gapped pris en charge. GDPR-aligned : aucun transfert de données vers des providers LLM tiers. Adapté aux secteurs régulés.' },
      ],
      privacyNote: 'Aucune donnée ne quitte votre infrastructure. La configuration par défaut s\'exécute 100% on-premise. Le LLM cloud est optionnel et opt-in — vous le configurez explicitement uniquement si vous le souhaitez.',
      privacyBadge: 'Aucune donnée ne quitte votre infrastructure',
      modelNote: 'Powered by Qwen3™-4B-Instruct-2507 · Apache 2.0 · mistral.rs™ · OpenAI®-compatible',
    },
    agentic: {
    ...
    securityCompliance: {
      ...
      title: 'ISO 27001 et NIS2. Scanné, pas auto-déclaré.',
      text: 'Un scanner de conformité automatisé lit le code source de Primebrick à chaque build et mappe les contrôles de sécurité vers ISO 27001 Annexe A, NIS2 Article 21(2) et OWASP Top 10 — avec preuve fichier:ligne pour chaque contrôle. Pas de questionnaires manuels. Téléchargez le rapport complet en PDF.',
      cards: [
        { title: 'ISO 27001 Annexe A', text: '17 contrôles mappés à l\'Annexe A (A.5, A.6, A.8) avec preuves : RBAC, audit trail, chiffrement, contrôle d\'accès.' },
        { title: 'NIS2 Article 21(2)', text: 'Les 10 mesures de sécurité obligatoires couvertes : gestion d\'incidents, continuité d\'activité, sécurité de la chaîne d\'approvisionnement.' },
        { title: 'OWASP Top 10', text: 'Injection, défaillances d\'authentification, défaillances cryptographiques, mauvaise configuration — mappés à des patterns de code réels avec preuves.' },
        { title: 'Rapport PDF téléchargeable', text: 'Rapport de conformité complet généré en PDF à chaque build. Remettez-le à vos auditeurs ou équipe de conformité.' },
      ],
      cta: { label: 'Voir le rapport de conformité', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    dataPrivacy: {
      badge: 'GDPR et CCPA',
      title: 'Privacy by design. Avec preuves.',
      text: 'Primebrick implémente les exigences GDPR et CCPA au niveau du code : isolation des données multi-tenant, soft-delete avec récupération, audit trails pour l\'Article 30, minimisation des données via contrôle d\'accès au niveau champ. Le scanner automatisé vérifie ces contrôles contre le code source réel.',
      cards: [
        { title: 'GDPR Article 32', text: 'Sécurité du traitement : chiffrement en transit, isolation multi-tenant, audit trails. Vérifié par analyse de code.' },
        { title: 'GDPR Article 17', text: 'Droit à l\'effacement : soft-delete avec colonne deleted_at et capacité de restauration. Les données sont récupérables.' },
        { title: 'CCPA §1798.150', text: 'Protection des données consommateurs : contrôles d\'accès, audit trails et minimisation des données mappés au California Consumer Privacy Act.' },
        { title: 'Registres Article 30', text: 'Audit trail automatisé satisfait aux exigences GDPR Article 30 d\'enregistrement du traitement. Chaque opération CRUD est journalisée.' },
      ],
      cta: { label: 'Voir l\'évaluation GDPR et CCPA', href: 'https://docs.primebrick.dev/getting-started/compliance-assessment' },
    },
    forDevs: {
    ...
    thankyou: {
      badge: 'Open Source • Construit Ensemble • Libre Pour Toujours',
      title: 'Merci',
      subtitle: 'Primebrick se tient sur les épaules de géants. Cette page est un remerciement sincère à chaque personne, équipe et organisation dont le travail open-source a rendu ce projet possible — dans chaque dépôt, chaque ligne de documentation et ce site lui-même.',
      spiritTitle: 'L\'Esprit de l\'Open Source',
      spiritText: 'L\'open source n\'est pas qu\'une licence — c\'est un pacte entre inconnus qui choisissent de partager leur meilleur travail avec le monde, gratuitement, pour toujours. Chaque ligne de code sur laquelle nous nous appuyons a été écrite par quelqu\'un qui a décidé que la collaboration compte plus que le contrôle, que la transparence bat le secret et que redonner est le but de tout.',
      quotes: [
        'Software is like sex: it\'s better when it\'s free. — Linus Torvalds',
        'Open source is a way of being that is about generosity. — Unknown',
        'If I have seen further it is by standing on the shoulders of giants. — Isaac Newton',
        'Le meilleur de l\'open source, c\'est qu\'on peut construire sur le travail des autres. — Anonyme',
      ],
      weThank: 'Nous remercions',
      sectionFoundation: 'Langages & Runtimes',
      sectionFrameworks: 'Les Frameworks',
      sectionBuild: 'Build & Outils',
      sectionUi: 'UI & Styles',
      sectionData: 'Données, Messagerie & Caching',
      sectionAuth: 'Auth & Sécurité',
      sectionAi: 'IA & Machine Learning',
      sectionDocs: 'Docs & Diagrammes',
      sectionExport: 'Templating & Export',
